...
IMPLEMENT_DYNAMIC(CPPageSubtitles, CDarkPPageBase)
CPPageSubtitles::CPPageSubtitles()
    : CDarkPPageBase(CPPageSubtitles::IDD, CPPageSubtitles::IDD)
...
BEGIN_MESSAGE_MAP(CPPageSubtitles, CDarkPPageBase)
