...
void CMPCThemeScrollBarHelper::setDarkDrawingArea(CRect &cr, CRect &wr, bool clipping) {
...
void CMPCThemeScrollBarHelper::updateDarkScrollInfo() {
    if (IsWindow(darkVSB.m_hWnd)) {
...
void CMPCThemeScrollBarHelper::darkNcPaintWithSB() {
    createSB();
...
void CMPCThemeScrollBarHelper::darkNcPaint(CWnd *window, CMPCThemeScrollable *swindow) {
