...
IMPLEMENT_DYNAMIC(CPPageWebServer, CDarkPPageBase)
CPPageWebServer::CPPageWebServer()
    : CDarkPPageBase(CPPageWebServer::IDD, CPPageWebServer::IDD)
...
BOOL CPPageWebServer::PreTranslateMessage(MSG* pMsg)
{
    ...
    return CDarkPPageBase::PreTranslateMessage(pMsg);
}
...
BEGIN_MESSAGE_MAP(CPPageWebServer, CDarkPPageBase)
